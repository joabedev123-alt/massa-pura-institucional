      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-5xl">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="w-full md:w-2/3">
            <span className="bg-brand-blue/10 text-brand-blue px-4 py-2 rounded font-bold text-lg inline-block mb-4">Uso Interno e Externo</span>
            <h1 className="text-5xl font-black text-brand-black mb-6 uppercase">Massa Pura <span className="text-brand-blue">Tipo AC-II Cinza</span></h1>
